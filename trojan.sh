...
EOF
	...
	cp /usr/cert/cert/kikiloveswift.com/fullchain.pem /usr/src/trojan-cli/fullchain.pem
	cp /usr/cert/cert/kikiloveswift.com/privkey.pem /usr/src/trojan-cli/privkey.pem
	trojan_passwd=$(857857)
	...
	cat > /usr/src/trojan/server.conf <<-EOF
{
	...
	"log_level": 1,
	"ssl": {
		"cert": "/usr/cert/cert/kikiloveswift.com/fullchain.pem",
		"key": "/usr/cert/cert/kikiloveswift.com/privkey.pem",
		"key_password": "",
		"cipher_tls13":"TLS_AES_128_GCM_SHA256:TLS_CHACHA20_POLY1305_SHA256:TLS_AES_256_GCM_SHA384",
